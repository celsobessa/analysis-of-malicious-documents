# Análise de documentos maliciosos - Parte 04 - Medidas defensivas, próximas etapas e encerramento
...
Algumas campanhas induzem os usuários a abrir arquivos nocivos disfarçados de documentos, mas que são outros tipos de arquivos, como aplicativos executáveis, arquivos .zip ou outros tipos de arquivos de contêiner, como .iso, etc. Geralmente, esses arquivos incluem até mesmo ícones personalizados para se parecerem com documentos do MS Word, PDFs, etc. Verificar cuidadosamente os arquivos que baixamos e abrimos nos dará outra camada de proteção ao detectar quando um arquivo não tem um tipo de arquivo comum ou esperado.
...
Específico para escritório: Minimizar o uso de macros em atividades legítimas

Mesmo que existam muitos casos de uso aceitáveis e inofensivos para macros, usar documentos com elas com frequência e estar acostumado a permiti-las pode abrir a porta para receber um documento malicioso e ativar suas macros acidentalmente, especialmente as organizações devem estar atentas a essa situação e planejar adequadamente ou remover o uso de macros ou preparar processos para conviver com elas, considerando como lidar com arquivos não confiáveis.
Específico para o Office: Desative as macros e verifique a Central de Confiança
